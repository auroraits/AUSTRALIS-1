...
| COMMS-UL-02 | B2 slotted shall habilitarse solo con base temporal validada; en otro caso shall usar B1 seguro. | Deriva worst-case permanece dentro del guard aprobado; pérdida de time validity fuerza B1. | T+A | ADR-20260313-b2-uplink-timebase-requirement | Node FW | Active |
...
| COMP-REQ-02 | El sistema shall implementar inhibits de funciones RF/deployables conforme CDS y requisitos adicionales ICD. | Inspección y fault-injection prueban número/independencia y timers; integrador acepta. | I+T | CDS Rev.14.1 §§2.3–2.4 | EPS/COMMS | Active |
