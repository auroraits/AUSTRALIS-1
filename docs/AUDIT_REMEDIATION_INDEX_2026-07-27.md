...
| SYS-M09 | Documento de time sync aún permitía NTP contra el baseline posterior. | `CORRECTED` | `08_Decisions/ADR-20260727-rf-regulatory-command-security-baseline.md`, `COMMS-UL-02` y los documentos TLE/scheduler superseden la ADR timebase histórica; exigen fuente validada y fail-silent sin aceptar una tecnología por nombre. |
