...
By submitting a contribution, you must be able to certify that:

- the contribution is your original work, or you have the right to submit it;
- it does not include secrets, credentials, private data or controlled material;
- it does not include third-party files unless their license is documented and
  compatible with the repository publication policy;
- it does not include generated model weights, checkpoints, tokenizer dumps,
  binary build outputs, Office/PDF reference files or backup archives.
...
Run the checks in `PUBLIC_RELEASE_PROCESS.md` before proposing release-related
changes.
